...
![cmd-ipconfig](/assets/lingchat/depoly_android/cmd-ipconfig.webp)
...
![手机前端演示](/assets/lingchat/depoly_android/手机前端演示.webp)
...
![](/assets/lingchat/depoly_android/restore-1.webp)

选择常规模式，回车，出现以下界面：

![](/assets/lingchat/depoly_android/restone-2.webp)

选右边那个，回车，出现以下界面：

![](/assets/lingchat/depoly_android/restone-3.webp)

输入一个 0 ，回车，等解压完成回车回到主界面。此时再进入 proot 界面，选择当前已安装容器列表，无脑回车即可打开容器。（此时需要等待容器加载完成）

> 如果出现以下界面，直接确定。
> ![](/assets/lingchat/depoly_android/batterychoose.webp)
...
![](/assets/lingchat/depoly_android/手机前端演示.webp)
