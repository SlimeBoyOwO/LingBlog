...
**灵门箴言** (点击下载音频: [maxim.mp3](/maxim.mp3))
...
- [Windows 教程](./deployment/win)
- [Android 教程](./deployment/android)
- [Linux 教程](./deployment/linux)

新版本介绍和下载指引看这个准没错！

- [版本介绍和下载链接](./deployment/version)

### 附加功能

LingChat还有很多附加的强力功能！你可以查看额外功能了解与启用：

- [RAG 功能](./expand/rag)：这是 LingChat 能够实现无限记忆的秘诀
- [语音生成](./expand/voice)：这可以给人物生成逼真的语音
- [视觉功能](./expand/vision)：这可以让人物看到你的桌面
